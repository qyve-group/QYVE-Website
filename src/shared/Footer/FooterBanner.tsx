...
const FooterBanner = () => {
  return (
    ...
    <div className="container pt-9 text-black w-full">
      {/* Video Background */}
      {/* <video
      ...
      <div className="w-full">
        <Heading className="mx-auto mb-0 w-full text-justify md:w-1/2" isCenter>
        ...
        <div className="mt-10 flex items-center justify-center">
          ...
          <Image src="/qyve-black.png" width={50} height={50} alt="Qyve logo" />
        </div>
      </div>
    </div>
  );

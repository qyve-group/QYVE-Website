...
const SubZeroHero = () => {
  return (
    <section className="relative min-h-[600px] overflow-hidden bg-gradient-to-br from-[#0a1f3d] via-[#0d3d5c] to-[#1a5a7a] md:min-h-[500px]">
      ...
      <div className="container relative z-10 mx-auto flex h-[600px] items-end justify-center px-4 pb-12 md:h-[500px] md:pb-16">

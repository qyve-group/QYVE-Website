...
export const CAMPAIGNS: Campaign[] = [
  {
    ...
    slug: 'sub-zero',
    description:
      "Introducing Sub-Zero, QYVE's revolutionary new shoe line designed for athletes who demand uncompromising performance. Built with cutting-edge technology and premium materials.",
    ...
    featuredProducts: ['sub-zero-pro', 'sub-zero-thermal', 'sub-zero-extreme'],
    lookbookProducts: [
      'sub-zero-pro',
      'sub-zero-thermal',
      'sub-zero-extreme',
    ...
    campaignAssets: {
      ...
      videos: ['/videos/campaigns/sub-zero/intro.mp4'],
    },
    seo: {
      title: 'Sub-Zero Collection - QYVE Revolutionary Performance Shoes',
      description:
        'Discover the Sub-Zero collection by QYVE. Revolutionary performance shoes engineered for athletes who demand excellence. Shop now.',
      keywords: [
        'sub-zero',
        'performance shoes',
        'QYVE',
...
export const CAMPAIGN_PRODUCTS: CampaignProduct[] = [
  {
    ...
    description:
      'The ultimate performance shoe. Features advanced cushioning technology, premium materials, and superior traction for exceptional performance.',
    category: 'futsal',
  ...
  },
  {
    ...
    description:
      'Premium comfort meets cutting-edge design. Perfect for training and athletic performance with advanced cushioning technology.',
    category: 'futsal',
    colors: ['black', 'gray'],
    sizes: [
      '6',
  ...
  },
  {
    ...
    description:
      'For the most demanding athletes. Advanced materials and construction for ultimate performance in any environment.',
    category: 'futsal',
    colors: ['black', 'white'],
    sizes: [
      '6',
  ...
  },
  {
    ...
    description:
      'Essential performance at an accessible price. Quality and comfort for everyday athletic activities.',
    category: 'futsal',
    colors: ['black', 'navy'],
    sizes: [
      '6',
...
export const getCampaignProducts = (
  ...
  return CAMPAIGN_PRODUCTS.filter(
    (product) =>
